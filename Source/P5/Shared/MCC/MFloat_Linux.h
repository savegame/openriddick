...
/*
	Scalar float primitives for the Linux/SDL2 port (x86_64, ARM, Android).
	Portable C implementation of the same function surface as
	MFloat_X86.h / MFloat_PS3.h; rounding uses lrintf/lrint (round to
	nearest, matching the original x87/AltiVec behaviour).
*/
...
{
	// Little-endian: the sign bit lives in the high word
