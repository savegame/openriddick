...
{
	// Om man k�nner att man har f�r mycket tid �ver, d� kan man roa sig med att skapa DCs.
...
void CImage::Internal_Line(CPnt p0, CPnt p1, CPixel32 col, uint8* pSurfMem)
{
	...
	// See Bjarne sid 195 f�r alt. algoritm.
...
#else
	// BLAH! Fanken �r det en vanlig memcpy eller?  *testar*
...
*/
/* 4.10 OBS ingen stackframe tillg�nglig.
...
// 6.87 OBS ingen stackframe tillg�nglig.
