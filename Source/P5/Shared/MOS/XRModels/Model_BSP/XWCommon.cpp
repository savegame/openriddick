...
void CBSP_CoreFace::Read(CCFile* _pF, int _Version)
{
	...
	// uint32 (lightmap-rect / spline-mapping indices used by the PC
	// renderer's lightmap atlas; unused by this engine snapshot).
	// The extra 8 bytes are skipped after the common part below.
	case 0x0203:
		{
			struct
			{
