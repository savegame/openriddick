...
его как «static». Это меняет диагноз: замороженный хвост — не «кость стоит в
bind-позе», а «кость невалидна», и любая вершина, привязанная к ней, уезжает
в бесконечность. Ровно то, что выглядит как полигон, растянутый через весь
экран.
