...
PARAM vec_right_upperleft = program.env[9];
PARAM vec_right_lowerright = program.env[10];
PARAM vec_down_upperleft = program.env[11];
PARAM vec_down_lowerright = program.env[12];
PARAM vec_left_upperleft = program.env[13];
PARAM vec_left_lowerright = program.env[14];
PARAM front_offset = {0, 16, 0, 0};
PARAM right_offset = {32, 16, 0, 0};
PARAM up_offset = {64, 16, 0, 0};
PARAM left_offset = {112, 16, 0, 0}; #{96 + 16, 0, 0, 0};	
...
#------------------------------------------------------------------------------------------------------------
# First do front
ADD box_divider.x, stepcount.x, -1;
ADD box_divider.y, stepcounthalf.x, -1;
...
REP stepcounthalf;
  ...
  REP stepcounthalf;
    ...
    MAD r1, right_offset.x, texdistu_frame, cur_pos_frame;
    MAD r1, right_offset.y, texdistv_frame, r1;
    TEX r0, r1, texture[0], 2D;

    LRP r1, tbox, vec_right_lowerright, vec_right_upperleft;
    NRM r1, r1;
